...
CASO 1: DATOS SIN AJUSTAR A DIVIDENDOS DE YF

CASO 2: DATOS AJUSTADOS A DIVIDENDOS DE YF (en teoría ajustados por factor de ajuste)
...
'''
EXPLICACIÓN CALCULO CONTENIDO EN CADA COLUMNA DE LOS DF's:
